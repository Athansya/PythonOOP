'''
Titulo: Simple Button

Objetivo: Crear una clase Button para instanciar botones con
metodos sencillos
'''
# Import packages
import pygame
...
class SimpleButton():
    ...
    def __init__(self, window, loc, up, down, callBack = None):
        self.window = window
        self.loc = loc
        self.surfaceUp = pygame.image.load(BASE_PATH + up)
        self.surfaceDown = pygame.image.load(BASE_PATH + down)
    ...
    def handleEvent(self, eventObj):
        ...
        if self.state == SimpleButton.STATE_IDLE:
            ...
            if eventPointInButtonRect:
                ...
                self.state = SimpleButton.STATE_IDEL
