...
Objetivo: Crear una clase base abstracta y subclases.
'''

# Balloon abstract base class and 3 subclasses
...
class Balloon(ABC):
    ...
    popSound = None  # Load when first ballon is created
